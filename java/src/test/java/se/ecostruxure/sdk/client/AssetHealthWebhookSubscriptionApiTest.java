...
/**
 * API tests for AssetHealthWebhookSubscriptionApi
 */
@Ignore
public class AssetHealthWebhookSubscriptionApiTest {

    private final AssetHealthWebhookSubscriptionApi api = new AssetHealthWebhookSubscriptionApi();
     ...
     */
    @Test
    public void deleteAssetHealthSubscriptionTest() {
        Object subscriptionId = null;
        api.deleteAssetHealthSubscription(subscriptionId);
     ...
     */
    @Test
    public void getAssetHealthSubscriptionTest() {
        Object subscriptionId = null;
        Object response = api.getAssetHealthSubscription(subscriptionId);
     ...
     */
    @Test
    public void getAssetHealthSubscriptionListTest() {
        Object response = api.getAssetHealthSubscriptionList();
     ...
     */
    @Test
    public void postAssetHealthSubscriptionTest() {
        AssetHealthSubscriptionConfig assetHealthSubscriptionConfig = null;
        Supscription response = api.postAssetHealthSubscription(assetHealthSubscriptionConfig);
     ...
     */
    @Test
    public void putAssetHealthSubscriptionTest() {
        Object subscriptionId = null;
        AssetHealthSubscriptionConfig assetHealthSubscriptionConfig = null;
        Object response = api.putAssetHealthSubscription(subscriptionId, assetHealthSubscriptionConfig);
