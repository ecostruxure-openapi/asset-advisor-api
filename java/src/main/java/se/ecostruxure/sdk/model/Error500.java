 ...
 */
@ApiModel(description = "Error occurred while processing the request")
@JsonPropertyOrder({
  Error500.JSON_PROPERTY_TYPE,
  Error500.JSON_PROPERTY_TITLE,
  Error500.JSON_PROPERTY_STATUS,
  Error500.JSON_PROPERTY_DETAIL
})
...
public class Error500 {
  ...
  public Error500 type(Object type) {
  ...
  **/
  ...
  @ApiModelProperty(example = "https://ecostruxure-openapi.se.com/problem/internal-server-error", required = true, value = "A URI reference [RFC3986] that identifies the problem type.")
  ...
  public Error500 title(Object title) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Internal Server Error", value = "A short, human-readable summary of the problem type.")
  @JsonIgnore
  ...
  public Error500 status(Object status) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "500", value = "The HTTP status code ([RFC7231], Section 6) generated by the origin server for this occurrence of the problem.")
  @JsonIgnore
  ...
  public Error500 detail(Object detail) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Something went wrong, please try again later.", value = "A human-readable explanation specific to this occurrence of the problem.")
  @JsonIgnore
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, error500.type) &&
        equalsNullable(this.title, error500.title) &&
        equalsNullable(this.status, error500.status) &&
        equalsNullable(this.detail, error500.detail);
  }
