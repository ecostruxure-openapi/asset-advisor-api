...
/**
 * Error occurred while authorizing the request (based on rfc7807)
 */
@ApiModel(description = "Error occurred while authorizing the request (based on rfc7807)")
@JsonPropertyOrder({
  Error403.JSON_PROPERTY_TYPE,
  Error403.JSON_PROPERTY_TITLE,
  Error403.JSON_PROPERTY_STATUS,
  Error403.JSON_PROPERTY_DETAIL
})
...
public class Error403 {
  ...
  public Error403 type(Object type) {
  ...
  **/
  ...
  @ApiModelProperty(example = "https://ecostruxure-openapi.se.com/problem/access-forbidden", required = true, value = "A URI reference [RFC3986] that identifies the problem type.")
  ...
  public Error403 title(Object title) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Access Forbidden", value = "A short, human-readable summary of the problem type.")
  @JsonIgnore
  ...
  public Error403 status(Object status) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "403", value = "The HTTP status code ([RFC7231], Section 6) generated by the origin server for this occurrence of the problem.")
  @JsonIgnore
  ...
  public Error403 detail(Object detail) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "User is not authorized to perform the action.", value = "A human-readable explanation specific to this occurrence of the problem.")
  @JsonIgnore
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, error403.type) &&
        equalsNullable(this.title, error403.title) &&
        equalsNullable(this.status, error403.status) &&
        equalsNullable(this.detail, error403.detail);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, hashCodeNullable(title), hashCodeNullable(status), hashCodeNullable(detail));
  }
