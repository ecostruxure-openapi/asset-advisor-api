...
@JsonPropertyOrder({
  Error404.JSON_PROPERTY_TYPE,
  Error404.JSON_PROPERTY_TITLE,
  Error404.JSON_PROPERTY_STATUS,
  Error404.JSON_PROPERTY_DETAIL
})
...
public class Error404 {
  ...
  public Error404 type(Object type) {
  ...
  **/
  ...
  @ApiModelProperty(example = "https://ecostructure-openapi.se.com/problem/not-found", required = true, value = "A URI reference [RFC3986] that identifies the problem type.")
  ...
  public Error404 title(Object title) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Not Found", value = "A short, human-readable summary of the problem type.")
  @JsonIgnore
  ...
  public Error404 status(Object status) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "404", value = "The HTTP status code ([RFC7231], Section 6) generated by the origin server for this occurrence of the problem.")
  @JsonIgnore
  ...
  public Error404 detail(Object detail) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Resource not found for provided identifier.", value = "A human-readable explanation specific to this occurrence of the problem.")
  @JsonIgnore
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, error404.type) &&
        equalsNullable(this.title, error404.title) &&
        equalsNullable(this.status, error404.status) &&
        equalsNullable(this.detail, error404.detail);
  }
