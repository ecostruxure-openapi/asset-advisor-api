...
public class AssetHealthWebhook {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.topic, assetHealthWebhook.topic) &&
        equalsNullable(this.id, assetHealthWebhook.id) &&
        equalsNullable(this.siteId, assetHealthWebhook.siteId) &&
        equalsNullable(this.assetId, assetHealthWebhook.assetId) &&
        equalsNullable(this.timestamp, assetHealthWebhook.timestamp) &&
        equalsNullable(this.events, assetHealthWebhook.events);
  }
