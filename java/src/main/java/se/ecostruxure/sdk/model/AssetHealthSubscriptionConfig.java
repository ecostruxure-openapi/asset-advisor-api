 ...
 */
@JsonPropertyOrder({
  AssetHealthSubscriptionConfig.JSON_PROPERTY_CALLBACK,
...
public class AssetHealthSubscriptionConfig {
  ...
  public static final String JSON_PROPERTY_HEALTH_INDEX_THRESHOLD = "healthIndexThreshold";
  ...
  public AssetHealthSubscriptionConfig callback(Object callback) {
   ...
   /**
   * callback url to be notified on modification
   * @return callback
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "https://example.com/samplewebhook/apiKey", required = true, value = "callback url to be notified on modification")
  ...
  public AssetHealthSubscriptionConfig healthIndexThreshold(Object healthIndexThreshold) {
    
    this.healthIndexThreshold = healthIndexThreshold;
    return this;
  }

   /**
   * Inclusive health index threshold
   * minimum: 1
   * maximum: 5
   * @return healthIndexThreshold
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "3", required = true, value = "Inclusive health index threshold")
  @JsonProperty(JSON_PROPERTY_HEALTH_INDEX_THRESHOLD)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public Object getHealthIndexThreshold() {
    return healthIndexThreshold;
  }
  ...
  @JsonProperty(JSON_PROPERTY_HEALTH_INDEX_THRESHOLD)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setHealthIndexThreshold(Object healthIndexThreshold) {
    this.healthIndexThreshold = healthIndexThreshold;
  }
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class AssetHealthSubscriptionConfig {\n");
    sb.append("    callback: ").append(toIndentedString(callback)).append("\n");
    sb.append("    healthIndexThreshold: ").append(toIndentedString(healthIndexThreshold)).append("\n");
    sb.append("    sitesScope: ").append(toIndentedString(sitesScope)).append("\n");
    sb.append("}");
    return sb.toString();
  }
