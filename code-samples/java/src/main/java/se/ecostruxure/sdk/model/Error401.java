...
@JsonPropertyOrder({
  Error401.JSON_PROPERTY_TYPE,
  Error401.JSON_PROPERTY_TITLE,
  Error401.JSON_PROPERTY_STATUS,
  Error401.JSON_PROPERTY_DETAIL
})
...
public class Error401 {
  ...
  public Error401 type(Object type) {
  ...
  **/
  ...
  @ApiModelProperty(example = "https://ecostructure-openapi.se.com/problem/unauthorized", required = true, value = "A URI reference [RFC3986] that identifies the problem type.")
  ...
  public Error401 title(Object title) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Unauthorized", value = "A short, human-readable summary of the problem type.")
  @JsonIgnore
  ...
  public Error401 status(Object status) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "401", value = "The HTTP status code ([RFC7231], Section 6) generated by the origin server for this occurrence of the problem.")
  @JsonIgnore
  ...
  public Error401 detail(Object detail) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Access Token expired", value = "A human-readable explanation specific to this occurrence of the problem.")
  @JsonIgnore
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, error401.type) &&
        equalsNullable(this.title, error401.title) &&
        equalsNullable(this.status, error401.status) &&
        equalsNullable(this.detail, error401.detail);
  }
