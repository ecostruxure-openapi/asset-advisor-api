 ...
 */
@JsonPropertyOrder({
  TicketHistory.JSON_PROPERTY_ACTIVITY_TYPE,
  TicketHistory.JSON_PROPERTY_DATE,
...
public class TicketHistory {
  ...
  **/
  ...
  public TicketHistory comment(Object comment) {
   ...
   /**
   * On some action, users can enter a free text comment
   * @return comment
  **/
  @javax.annotation.Nullable
  ...
  public TicketHistory _file(Object _file) {
   ...
   /**
   * Attachment, if available. Only the file name is provided at this release
   * @return _file
  **/
  @javax.annotation.Nullable
