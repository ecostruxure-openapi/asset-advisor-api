 ...
 */
@JsonPropertyOrder({
  SiteRiskLevelSubscriptionConfig.JSON_PROPERTY_CALLBACK,
...
public class SiteRiskLevelSubscriptionConfig {
  ...
  public static final String JSON_PROPERTY_RISK_LEVEL_THRESHOLD = "riskLevelThreshold";
  ...
  public SiteRiskLevelSubscriptionConfig callback(Object callback) {
  ...
  **/
  ...
  public SiteRiskLevelSubscriptionConfig riskLevelThreshold(Object riskLevelThreshold) {
   ...
   /**
   * Inclusive site risk level threshold in percentage
   * minimum: 0
   * maximum: 100
   * @return riskLevelThreshold
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "80", required = true, value = "Inclusive site risk level threshold in percentage")
  @JsonProperty(JSON_PROPERTY_RISK_LEVEL_THRESHOLD)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public Object getRiskLevelThreshold() {
    return riskLevelThreshold;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RISK_LEVEL_THRESHOLD)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setRiskLevelThreshold(Object riskLevelThreshold) {
    this.riskLevelThreshold = riskLevelThreshold;
  }
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class SiteRiskLevelSubscriptionConfig {\n");
    sb.append("    callback: ").append(toIndentedString(callback)).append("\n");
    sb.append("    riskLevelThreshold: ").append(toIndentedString(riskLevelThreshold)).append("\n");
