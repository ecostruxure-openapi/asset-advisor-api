...
/**
 * API tests for TicketWebhookSubscriptionApi
 */
@Ignore
public class TicketWebhookSubscriptionApiTest {

    private final TicketWebhookSubscriptionApi api = new TicketWebhookSubscriptionApi();
     ...
     */
    @Test
    public void deleteTicketSubscriptionTest() {
        Object subscriptionId = null;
        api.deleteTicketSubscription(subscriptionId);
     ...
     */
    @Test
    public void getTicketSubscriptionTest() {
        Object subscriptionId = null;
        Object response = api.getTicketSubscription(subscriptionId);
     ...
     */
    @Test
    public void getTicketSubscriptionListTest() {
        Object response = api.getTicketSubscriptionList();
     ...
     */
    @Test
    public void postTicketSubscriptionTest() {
        TicketSubscriptionConfig ticketSubscriptionConfig = null;
        Supscription response = api.postTicketSubscription(ticketSubscriptionConfig);
     ...
     */
    @Test
    public void putTicketSubscriptionTest() {
        Object subscriptionId = null;
        TicketSubscriptionConfig ticketSubscriptionConfig = null;
        Object response = api.putTicketSubscription(subscriptionId, ticketSubscriptionConfig);
