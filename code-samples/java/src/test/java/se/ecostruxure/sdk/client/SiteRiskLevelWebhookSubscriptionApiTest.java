...
/**
 * API tests for SiteRiskLevelWebhookSubscriptionApi
 */
@Ignore
public class SiteRiskLevelWebhookSubscriptionApiTest {

    private final SiteRiskLevelWebhookSubscriptionApi api = new SiteRiskLevelWebhookSubscriptionApi();
     ...
     */
    @Test
    public void deleteSiteRiskLevelSubscriptionTest() {
        Object subscriptionId = null;
        api.deleteSiteRiskLevelSubscription(subscriptionId);
     ...
     */
    @Test
    public void getSiteRiskLevelSubscriptionTest() {
        Object subscriptionId = null;
        Object response = api.getSiteRiskLevelSubscription(subscriptionId);
     ...
     */
    @Test
    public void getSiteRiskLevelSubscriptionListTest() {
        Object response = api.getSiteRiskLevelSubscriptionList();
     ...
     */
    @Test
    public void postSiteRiskLevelSubscriptionTest() {
        SiteRiskLevelSubscriptionConfig siteRiskLevelSubscriptionConfig = null;
        Supscription response = api.postSiteRiskLevelSubscription(siteRiskLevelSubscriptionConfig);
     ...
     */
    @Test
    public void putSiteRiskLevelSubscriptionTest() {
        Object subscriptionId = null;
        SiteRiskLevelSubscriptionConfig siteRiskLevelSubscriptionConfig = null;
        Object response = api.putSiteRiskLevelSubscription(subscriptionId, siteRiskLevelSubscriptionConfig);
